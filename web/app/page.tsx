    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="flex flex-col items-center justify-center text-center py-20 md:py-32 px-4 md:px-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto">
          <Link href="https://npmjs.com/samengine" target="_blank" className="w-full sm:w-auto">
            <button className="w-full sm:w-auto bg-white text-black px-6 py-3 rounded-xl font-semibold hover:bg-gray-200 transition">
              Download Package
            </button>
          </Link>
          ...
          <Link href="/source" className="w-full sm:w-auto">
            <button className="w-full sm:w-auto border border-white px-6 py-3 rounded-xl hover:bg-white hover:text-black transition">
              Source (Github)
            </button>
          </Link> */}
      ...
      <section className="py-16 md:py-24 px-4 md:px-6 bg-zinc-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 max-w-6xl mx-auto">
          {[
            ...
            <div
              key={i}
              className="p-5 md:p-6 rounded-2xl bg-black border border-zinc-800 hover:border-white transition"
            >
